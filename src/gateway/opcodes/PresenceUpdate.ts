...
export async function onPresenceUpdate(this: WebSocket, { d }: Payload) {
    ...
    // Redis presence cache: fast reads for "is this user online" without hitting Postgres.
    // Best-effort only — DB remains the source of truth, this never blocks or throws.
    void RedisCache.setPresence(this.user_id, presence.status as string, 90);
